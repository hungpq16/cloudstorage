...
class CloudStorageApplicationTests {
	...
	public void createNote() {
		...
		WebElement addNewNoteButton = driver.findElement(By.id("btn-add-note"));
		...
		WebElement submitNote = driver.findElement(By.id("btn-submit-note"));
		submitNote.click();
	...
	public void cCredential() {
		...
		WebElement addNewCredentialButton = driver.findElement(By.id("btn-add-credential"));
		...
		// Submit
		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("btn-credential-submit")));
		WebElement submitNote = driver.findElement(By.id("btn-credential-submit"));
		submitNote.click();
